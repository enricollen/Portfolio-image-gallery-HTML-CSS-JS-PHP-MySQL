...
<html>
 ...
 <body>
  <br /><br />
  <div class="container">
   <h2 align="center">Image Folder Manager</a></h2>
   <form action="../pannello_admin.php" method="get">
    <input type="submit" value="BACK" 
         name="Submit" id="frm1_submit" />
</form>
   <br />
   <div align="right">
   	<button style="background-color: blue; border:black;" onclick="location.href='../gestore_immagini.php'" type="button" class="btn btn-success">Image Caption Manager</button>
...
$(document).ready(function(){
 ...
 $(document).on("click", ".delete", function(){
  var folder_name = $(this).data("name");
  var action = "delete";
  if(confirm("Do you want to delete that folder?"))
  {
   $.ajax({
    url:"action.php",
    method:"POST",
